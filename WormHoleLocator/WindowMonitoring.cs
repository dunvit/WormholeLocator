...
namespace WHLocator
{
    public partial class WindowMonitoring : Form
    {
        ...
        {
            lblSolarSystemName.Font = new Font(Global.Fonts.Families[0], lblSolarSystemName.Font.Size);
            lblPilotName.Font = new Font(Global.Fonts.Families[0], lblSolarSystemName.Font.Size);

            lnlSystemText.Font = new Font(Global.Fonts.Families[0], lnlSystemText.Font.Size);
        ...
        private void cmdPin_Click(object sender, EventArgs e)
        {
            if (_windowIsPinned)
            {
                ...
                cmdPin.Image = Icons.pin;
                TopMost = false;
            }
            else
            {
                _windowIsPinned = true;
                cmdPin.Image = Icons.unpin;
                TopMost = true;
            }
        }
        ...
        private void cmdMinimazeRestore_Click(object sender, EventArgs e)
        {
            if (_windowIsMinimaze)
            {
                ...
                cmdMinimazeRestore.Image = Icons.minimize;
            ...
            else
            {
                ...
                cmdMinimazeRestore.Image = Icons.restore;
                lblSolarSystemName.Visible = true;
